...
<html lang="zh-CN"><head>
    ...
    <style type="text/css">
        ...
        .box{width:624px;height:188px;padding:99px 30px 0 184px;background:url(maintenance.png) no-repeat 0 0;position:absolute;margin:-144px 0 0 -419px;top:50%;left:50%;font-size:14px;line-height:24px;}
...
<div class="box">
    ...
    <div class="text">
        <p style="color:red;font-size:16px;">本网站收到了不明来历的恶意攻击，后台系统升级中。</p>
